...
export function Footer({ children }: { children?: ReactNode }) {
  return (
    <footer className="rule-t border-hairline px-6 md:px-16 py-14">
      <div className="mx-auto max-w-360 grid grid-cols-12 gap-6">
      ...
      <div className="mx-auto max-w-360 rule-t border-hairline mt-14 pt-6 flex flex-col md:flex-row justify-between gap-3 font-mono text-[10px] tracking-widest2 uppercase text-titanium/60">
